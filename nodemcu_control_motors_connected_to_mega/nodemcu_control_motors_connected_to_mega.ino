...
const String homePage = "<!DOCTYPE html><html><head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><title>CrazyRob</title><style>html,body{height:100%;}body{color:#333;font-family:'Ubuntu',cursive;display:flex;justify-content:center;flex-direction:column;align-items:center;}div{max-width:70%;display:flex;justify-content:space-between;flex-wrap:wrap;}a{width:40px;display:inline-block;padding:2em;margin:0.5em;text-decoration:none;color:#333;box-shadow: 0px 1px 5px 0 rgba(0,0,0,0.3);}a:hover,a:active{box-shadow: 0px 1px 5px 0 rgba(0,0,0,0.5);}</style></head><body><h1>CrazyRob</h1><div><a href=\"XNext\">Ileri</a><a href=\"XBack\">Geri</a><a href=\"YNext\">Asagi</a><a href=\"YBack\">Yukari</a><a href=\"ZNext\">Sag</a><a href=\"ZBack\">Sol</a><a href=\"GOpen\">Gripper Kapat</a><a href=\"GClose\">Gripper Ac</a></div></body></html>";
